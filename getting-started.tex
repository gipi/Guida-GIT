...
\noindent \`E possibile anche specificare anche una referenza a partire da una notazione
temporale
\smallskip
\noindent\line{\hfil\verbatim <ref>@{DATE SPECIFICATION} |endverbatim\hfil}
\noindent\line{\hfil\verbatim <ref>@{ORDINAL SPECIFICATION} |endverbatim\hfil}
\noindent\line{\hfil\verbatim <rev>^ |endverbatim\hfil}
\noindent\line{\hfil\verbatim <rev>~N |endverbatim\hfil}
\smallskip
...
Prima di tutto se non lo sia ha gi\`a si scarica l'albero dei sorgenti
\iniziacode
...
dall'usare come eseguibile un eventuale pacchetto pi\`u vecchio). Purtroppo a
meno di workaround non conosciuti da me \code{man} non restituir\`a la pagina di
