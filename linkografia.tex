...
with interesting example of not basic stuffs with \code{GIT}.
...
\link http://pcottle.github.io/learnGitBranching/: Nice web application that allows to play with git primitives.
